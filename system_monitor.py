...
Мониторит CPU (Intel), RAM, GPU (Intel/Nvidia) с автообновлением 2 секунды
"""
        ...
        <body>
            <div class="container">
                <div class="header">
                    ...
                    <p>Режим реального времени | Обновление каждые 2 секунды</p>
                </div>
...
def main():
    ...
    try:
        while True:
            ...
            print("-" * 50)
            print("Обновление через 2 секунды...")
